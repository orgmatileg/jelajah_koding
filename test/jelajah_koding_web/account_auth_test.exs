defmodule JelajahKodingWeb.AccountAuthTest do
  use JelajahKodingWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias JelajahKoding.Accounts
  alias JelajahKodingWeb.AccountAuth
  import JelajahKoding.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, JelajahKodingWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      JelajahKodingWeb.Endpoint.subscribe(live_socket_id)
