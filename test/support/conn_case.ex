defmodule JelajahKodingWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use JelajahKodingWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint JelajahKodingWeb.Endpoint

      use JelajahKodingWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import JelajahKodingWeb.ConnCase
    end
  end

  setup tags do
    JelajahKoding.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_account(%{conn: conn}) do
    account = JelajahKoding.AccountsFixtures.account_fixture()
  ...
  def log_in_account(conn, account) do
    token = JelajahKoding.Accounts.generate_account_session_token(account)
  ...
  def register_and_log_in_admin(%{conn: conn}) do
    admin = JelajahKoding.BackofficeFixtures.admin_fixture()
  ...
  def log_in_admin(conn, admin) do
    token = JelajahKoding.Backoffice.generate_admin_session_token(admin)
