defmodule JelajahKodingWeb.AdminAuth do
  use JelajahKodingWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias JelajahKoding.Backoffice

  # Make the remember me cookie valid for 60 days.
  # If you want bump or reduce this value, also change
  # the token expiry itself in AdminToken.
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_jelajah_koding_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule JelajahKodingWeb.PageLive do
        ...
        on_mount {JelajahKodingWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{JelajahKodingWeb.AdminAuth, :ensure_authenticated}] do
